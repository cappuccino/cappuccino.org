    ...
    *New in Pygments 1.3.*
    ...
    tokens = {
        ...
        'statements': [
            ...
            (r'(var|with|function|@typedef)\b', Keyword.Declaration, 'slashstartsregex'),

            (r'(@selector|@private|@protected|@public|@encode|'
             r'@synchronized|@try|@throw|@catch|@finally|@end|@property|'
             r'@synthesize|@dynamic|@for|@accessors|new|@ref|@deref|'
             r'@global)\b', Keyword),
            ...
            (r'(self|super)\b', Keyword.Reserved),
            ...
            (r'(Array|Boolean|Date|Error|Function|Math|netscape|'
             ...
             r'decodeURIComponent|encodeURI|encodeURIComponent|'
             r'Error|eval|isFinite|isNaN|parseFloat|parseInt|document|this|'
             r'window|CG[\w\d_]+|CP[\w\d_]+)\b', Name.Builtin),
        ...
        'function_signature': [
            ...
            (r'(\(' + _ws + r')'                # open paren
             r'(@action|[a-zA-Z_][a-zA-Z0-9_]+)'        # return type
